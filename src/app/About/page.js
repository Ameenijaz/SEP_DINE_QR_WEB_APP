...
function AboutUs() {
  ...
  return (
    <main>
<Navber/>
<div className="contact-warp pt-28 " style={{fontFamily:'-moz-initial'}} >
    <div className="about-sec  bg-white rounded-lg shadow-lg " >
      <div className="p-12 flex gap-4 mt-10 border-b-4 border-dotted border-b-red-600    ">
