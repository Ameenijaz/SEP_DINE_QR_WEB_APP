...
import  {FetchItems} from "../action/fooditems";
...
const Foodpopu = ({ onClose, item }) => {
  ...
  return (
    <div className="fixed w-[800px] h-auto overflow-hidden overflow-y-auto custom-scrollbar top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
      <div className="relative  bg-gray-100 border  border-emerald-200 p-4 rounded-2xl shadow-lg backdrop-blur-lg ">
        <div
          className="absolute top-2 right-2 cursor-pointer p-1 rounded-full bg-gray-100 shadow-md"
          onClick={onClose}
        >
